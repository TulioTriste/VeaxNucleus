...
public class ComboCommand extends Command {

    public ComboCommand() {
        super("combo", "bungee.staff");
    }
    ...
    public void execute(CommandSender commandSender, String[] strings) {
        ...
        if (player.getServer().getInfo().getName().equals("Combo")) {
            player.sendMessage(CC.translate("&cAlready connected!"));
            return;
        }
        ServerInfo serverInfo = ProxyServer.getInstance().getServerInfo("Combo");
